                ...
                <div class="card">
                  <div class="card-header py-2">
                    <div class="d-flex justify-content-between align-items-center">
                      <div>
                      <h6 class="fs-17 font-weight-600 mb-0">គ្រប់គ្រងអតិថិជន</h6>
                      </div>
                      <div class="text-right">
                      <a href="add-customer.php" class="btn btn-info btn-sm mr-1"><i class="fas fa-plus mr-1"></i>បន្ថែមអតិថិជន</a>
                      </div>
                    </div>
                  </div>
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        <?php
                          $n = 0;
                          $sql = $conn->query("SELECT * FROM `customer` WHERE `user` = '$_SESSION[user_id]'");
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="actions/remove.php?remove&code=<?php echo base64_encode($row['id']); ?>&wr=<?php echo base64_encode("customer"); ?>" class="btn btn-danger btn-sm delete" onclick="return confirm('Are you sure to delete?')"> <i class="fa fa-trash"></i> </a>
                          </td>
                        </tr>
                        <!-- Modal  start -->
