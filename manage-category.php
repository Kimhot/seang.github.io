                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="text-right">
                      <a href="add-category.php" class="btn btn-info btn-sm mr-1"><i class="fas fa-plus mr-1"></i>New Category</a>
                    </div>
                  ...
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo ++$n; ?></td>
                          <td><img src="dist/img/category/<?php echo $row['img'] ?>" alt="" style="width: 50px;"></td>
