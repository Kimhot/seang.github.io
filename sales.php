              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">របាយការណ៍ ការលក់</h3>
                  </div>
                    ...
                    <table id="example1" class="table table-bordered table-hover">
                      <thead>
                        ...
                        <!-- /  <th>Paid</th>  9 -->
                          ...
                          <th>Nº</th> <!-- 1 -->
                          <th>លេខវិក្ក័យបត្រ</th>  <!-- 2 -->
                          <th>ឈ្មោះអតិថជន</th>  <!-- 3 -->
                          <th>ផលិតផល</th>  <!-- 4 -->
                          <th>ថ្ងៃខែឆ្នាំ</th>  <!-- 5 -->
                          <th>តម្លៃសរុប</th>  <!-- 6 -->
                          <th>ការបញ្ចុះតម្លៃ</th>  <!-- 7 -->
                          <th>ទទួលទឹកប្រាក់</th>  <!-- 8 -->
                          <th>ការបង់</th>  <!-- 9 -->
                          <th>លុយអាប់</th>  <!-- 10 -->
                          <!-- <th>Purchase Cost</th>  11 -->
                          <th>ប្រាក់ចំនេញ</th>  <!-- 12 -->
                          <th>ស្ថានភាព</th>  <!-- 13 -->
                          <th>គ្រប់គ្រង</th>  <!-- 14 -->
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                          $n = 0;
                          $sql = $conn->query("SELECT * FROM `p_invoice_summary` WHERE `user` = '$_SESSION[user_id]' ORDER BY `id` DESC");
                        ...
                        <tr>
                          ...
                          <?php 
                            if($row['client'] != "Walk-in-Customer"){
                              $row2 = mysqli_fetch_assoc($conn->query("SELECT `id`,`name` FROM `customer` WHERE `user` = '$_SESSION[user_id]' AND `id` = $row[client]"));
                              echo $row2['name'];
                              $customer = $row2['name'];
                            }else{
                              echo $row['client'];
