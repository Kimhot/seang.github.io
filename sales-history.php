<?php
      ...
      $name = mysqli_fetch_assoc($conn->query("SELECT `name` FROM `customer` WHERE `id` = '$client'"));
		}
?>
<!DOCTYPE html>
<html lang="en">
                  ...
                  <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        <?php
                          $n = 0;
                          $sql = $conn->query("SELECT * FROM `p_invoice_summary` WHERE `user` = '$_SESSION[user_id]' AND `client` = '$client' ORDER BY `id` DESC");
